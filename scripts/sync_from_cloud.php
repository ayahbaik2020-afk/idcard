 ...
 * Run by cron/Task Scheduler every N minutes, or by the local "Sync Now"
 * button (see public/sync_now.php).
 *
...
sync_log('Pulling pending registrations/sanctions from cloud...');
...
sync_log('Menyusun snapshot untuk dikirim balik ke cloud...');
